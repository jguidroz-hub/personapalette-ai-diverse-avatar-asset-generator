...
const FROM = process.env.EMAIL_FROM || 'PersonaPalette AI - Diverse Avatar & Asset Generator <noreply@example.com>';
const APP_NAME = 'PersonaPalette AI - Diverse Avatar & Asset Generator';
