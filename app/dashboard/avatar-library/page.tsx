...
export default function AvatarLibraryPage() {
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/avatar-library/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Avatar Asset Library</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Browse and manage generated avatars</p>
