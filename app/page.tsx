  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PersonaPalette AI - Diverse Avatar & Asset Generator</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Provides designers and content creators with an endless supply of customizable, high-quality, and diverse avatars and visual assets, eliminating tedious searching and ensuring inclusive representation in digital projects and marketing materials.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PersonaPalette AI - Diverse Avatar & Asset Generator.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PersonaPalette AI - Diverse Avatar & Asset Generator. All rights reserved.</p>
